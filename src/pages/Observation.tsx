...
export default function Observation() {
  ...
  return (
    <>
      ...
      {/* 件数表示 */}
      <div style={{ fontSize: '12px', color: colors.subtext, marginBottom: '20px' }}>
      ...
      {displayed.length === 0 ? (
        <div style={{
          ...
          color: colors.subtext, fontSize: '13px', fontStyle: 'italic',
        }}>
          このタグの記録はまだありません
        </div>
      ) : (
...
// ── 観測カード ──
function ObsCard({ item, onTagClick }: {
  item: Item;
    ...
    <div style={{
      ...
      <div style={{ padding: '12px 14px' }}>
        <div style={{
          ...
          color: colors.text, marginBottom: '5px',
          fontFamily: fonts.serif,
        }}>
          {item.title}
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between',
          fontSize: '10px', color: colors.subtext }}>
